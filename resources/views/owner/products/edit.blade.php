...
<div class="card">
    <div class="card-header">
        <i class="bi bi-pencil me-2"></i>Edit Produk: {{ $product->name }}
    </div>
    <div class="card-body">
        <form action="{{ route('owner.products.update', [$outlet->id, $product->id]) }}" method="POST"
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="use_stock" name="use_stock"
                                    value="1" {{ $product->use_stock ? 'checked' : '' }}>
                                <label class="form-check-label" for="use_stock">Gunakan Stok</label>
                            </div>
                        </div>

                        <div class="col-md-4 stock-field" style="{{ $product->use_stock ? '' : 'display: none;' }}">
...
<script>
    ...
    $('.stock-field').toggle(this.checked);
});
</script>
@endpush